 ...
 * [ ] - nothing found, expected: `_G.gcinfo` function
 ...
 * [ ] + `_G._GOPHER_LUA_VERSION` string found, nothing expected
 * [ ] + `_G._printregs` function found, nothing expected
 * [ ] + `_G.channel` table found, nothing expected
# Checking coroutine
...
# Checking debug
 * [ ] - nothing found, expected: `debug.debug` function
 * [ ] - nothing found, expected: `debug.gethook` function
 * [x] `debug.getinfo` function
 * [x] `debug.getlocal` function
 * [x] `debug.getmetatable` function
 * [ ] - nothing found, expected: `debug.getregistry` function
 * [x] `debug.getupvalue` function
 * [ ] - nothing found, expected: `debug.sethook` function
 ...
 * [ ] - nothing found, expected: `file.__gc` function
 ...
 * [ ] + `os.setenv` function found, nothing expected
# Checking package
 * [ ] - nothing found, expected: `package.loadlib` function
 * [ ] - nothing found, expected: `package.config` string
 * [ ] - nothing found, expected: `package.cpath` string
 * [ ] - nothing found, expected: `package.path` string
 * [ ] - nothing found, expected: `package.loaded` table
 * [ ] - nothing found, expected: `package.preload` table
 * [ ] - nothing found, expected: `package.seeall` function
 * [ ] - nothing found, expected: `package.loaders` table
# Checking string
 ...
 * [ ] + `string.__index` table found, nothing expected
# Checking table
 ...
 * [ ] - nothing found, expected: `table.foreach` function
 * [ ] - nothing found, expected: `table.foreachi` function
 * [x] `table.getn` function
 * [ ] - nothing found, expected: `table.setn` function
# Checking utf8
